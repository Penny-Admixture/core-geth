...
func TestGetBlockHeaders64(t *testing.T) { testGetBlockHeaders(t, ETH64) }
...
func TestGetBlockBodies64(t *testing.T) { testGetBlockBodies(t, ETH64) }
...
func TestGetNodeData64(t *testing.T) { testGetNodeData(t, ETH64) }
...
func testGetNodeData(t *testing.T, protocol uint) {
	...
	generator := func(i int, block *core.BlockGen) {
		...
		case 0:
			...
			tx, _ := types.SignTx(types.NewTransaction(block.TxNonce(testAddr), acc1Addr, big.NewInt(10000), vars.TxGas, nil, nil), signer, testKey)
			block.AddTx(tx)
		case 1:
			// In block 2, the test bank sends some more ether to account #1.
			// acc1Addr passes it on to account #2.
			tx1, _ := types.SignTx(types.NewTransaction(block.TxNonce(testAddr), acc1Addr, big.NewInt(1000), vars.TxGas, nil, nil), signer, testKey)
...
func TestGetBlockReceipts64(t *testing.T) { testGetBlockReceipts(t, ETH64) }
